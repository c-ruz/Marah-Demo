...
Espere a que se acabe el tiempo de la actividad. Si lo desea, puede seguir usando la solución que conseguida durante el desarrollo de la T1, para continuar con el desarrollo de la [T2](T2.md).
Si no, puede cambiar a la rama `T1-solution` y continuar con la T2 usándola como base.